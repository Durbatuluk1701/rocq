...
let op_to_register_name = function
  | Int63head0 -> "int63_head0"
  | Int63tail0 -> "int63_tail0"
  | Int63add -> "int63_add"
  | Int63sub -> "int63_sub"
  | Int63mul -> "int63_mul"
  | Int63div -> "int63_div"
  | Int63mod -> "int63_mod"
  | Int63divs -> "int63_divs"
  | Int63mods -> "int63_mods"
  | Int63lsr -> "int63_lsr"
  | Int63lsl -> "int63_lsl"
  | Int63asr -> "int63_asr"
  | Int63land -> "int63_land"
  | Int63lor -> "int63_lor"
  | Int63lxor -> "int63_lxor"
  | Int63addc -> "int63_addc"
  | Int63subc -> "int63_subc"
  | Int63addCarryC -> "int63_addcarryc"
  | Int63subCarryC -> "int63_subcarryc"
  | Int63mulc -> "int63_mulc"
  | Int63diveucl -> "int63_diveucl"
  | Int63div21 -> "int63_div21"
  | Int63addMulDiv -> "int63_addmuldiv"
  | Int63eq -> "int63_eq"
  | Int63lt -> "int63_lt"
  | Int63le -> "int63_le"
  | Int63lts -> "int63_lts"
  | Int63les -> "int63_les"
  | Int63compare -> "int63_compare"
  | Int63compares -> "int63_compares"
  | Float64opp -> "float64_opp"
  | Float64abs -> "float64_abs"
  | Float64eq -> "float64_eq"
  | Float64lt -> "float64_lt"
  | Float64le -> "float64_le"
  | Float64compare -> "float64_compare"
  | Float64equal -> "float64_equal"
  | Float64classify -> "float64_classify"
  | Float64add -> "float64_add"
  | Float64sub -> "float64_sub"
  | Float64mul -> "float64_mul"
  | Float64div -> "float64_div"
  | Float64sqrt -> "float64_sqrt"
  | Float64ofUint63 -> "float64_of_uint63"
  | Float64normfr_mantissa -> "float64_normfr_mantissa"
  | Float64frshiftexp -> "float64_frshiftexp"
  | Float64ldshiftexp -> "float64_ldshiftexp"
  | Float64next_up -> "float64_next_up"
  | Float64next_down -> "float64_next_down"
...
let const_to_register_name = function
  | Arraymaxlength -> "array_max_length"
  | Stringmaxlength -> "string_max_length"

let op_or_type_to_register_token = function
  | OT_op op -> op_to_register_name op
  | OT_type ty -> prim_type_to_string ty
  | OT_const c -> const_to_register_name c
